...
import { Typography, Row, Col, Card, Statistic, Button, Space, List, Avatar } from 'antd';
import { 
  ArrowUpOutlined, 
  ArrowDownOutlined, 
  UserAddOutlined, 
    ...
    <div style={{ maxWidth: 1400, margin: '0 auto' }}>
      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: 32 }}>
        ...
        <Space>
          ...
          <Button type="primary" icon={<DownloadOutlined />} style={{ borderRadius: 8 }}>Báo cáo</Button>
        </Space>
      </div>
